...
void initialise_idt_driver(){
    ...
    setRawInterrupt(0x00,Error00);
    setRawInterrupt(0x01,Error01);
    setRawInterrupt(0x02,Error02);
    setRawInterrupt(0x03,Error03);
    setRawInterrupt(0x04,Error04);
    setRawInterrupt(0x05,Error05);
    setRawInterrupt(0x06,Error06);
    setRawInterrupt(0x07,Error07);
    setRawInterrupt(0x08,Error08);
    setRawInterrupt(0x09,Error09);
    setRawInterrupt(0x0A,Error0A);
    setRawInterrupt(0x0B,Error0B);
    setRawInterrupt(0x0C,Error0C);
    setRawInterrupt(0x0D,Error0D);
    setRawInterrupt(0x0E,Error0E);
    setRawInterrupt(0x0F,Error0F);
    setRawInterrupt(0x10,Error10);
    setRawInterrupt(0x11,Error11);
    setRawInterrupt(0x12,Error12);
    setRawInterrupt(0x13,Error13);
    setRawInterrupt(0x14,Error14);
    setRawInterrupt(0x15,Error15);
    setRawInterrupt(0x16,Error16);
    setRawInterrupt(0x17,Error17);
    setRawInterrupt(0x18,Error18);
    setRawInterrupt(0x19,Error19);
    setRawInterrupt(0x1A,Error1A);
    setRawInterrupt(0x1B,Error1B);
    setRawInterrupt(0x1C,Error1C);
    setRawInterrupt(0x1D,Error1D);
    setRawInterrupt(0x1E,Error1E);
    setRawInterrupt(0x1F,Error1F);
