...
start:
        ...
        ;call   get_params
        ;jc     information
        mov [input_file],filename_in
        mov     eax,401
        mov     ecx,1
        mov     edi,input_file
        int 0x81
        mov     [output_file],filename_out
        mov     eax,401
        mov     ecx,2
        mov     edi,output_file
        int 0x81
        mov     [symbols_file],0
        mov     [memory_setting],100
...
_logo db 'flat assembler  version ',VERSION_STRING,' for SanderOS64',0
_usage db 0xA
...
filename_in db "A:TEST.ASM",0
filename_out db "A:TEST.BIN",0
